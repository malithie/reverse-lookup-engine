...
import lk.uom.cse.msc.rle.parsers.RuleParser;
...
public class RuleParserTest {
    ...
    RuleType createRule() {
        ...
        RuleType ruleType = Mockito.mock(RuleType.class);
        when(ruleType.getRuleId()).thenReturn("AllowedItemAllowance");
        when(ruleType.getEffect()).thenReturn(EffectType.PERMIT);
        when(ruleType.getTarget()).thenReturn(targetType);
        when(ruleType.getCondition()).thenReturn(null);
